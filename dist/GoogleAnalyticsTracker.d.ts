...
import { CustomDimensionsFieldIndexMap } from "./models/Custom";
/**
...
declare class GoogleAnalyticsTracker {
     ...
     */
    trackCampaignFromUrl(urlString: string, screenName: string): void;
    /**
     ...
     * @param  {HitPayload} payload (Optional) An object containing the hit payload
     */
    trackEvent(category: string, action: string, eventMetadata?: EventMetadata, payload?: HitPayload): void;
    /**
     ...
     * @param  {HitPayload} payload (Optional) An object containing the hit payload
     */
    trackTiming(category: string, interval: number, timingMetadata: TimingMetadata, payload?: HitPayload): void;
    /**
     * Track an exception
     * @example
     * try {
